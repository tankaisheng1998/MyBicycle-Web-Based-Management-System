...
<div class="container-fluid">
  <div class="row">
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          <label for="staffphone" class="col-sm-3 control-label">Staff Phone Number</label>
          <div class="col-sm-9">   
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">   
      <input name="staffpass" type="text" class="form-control" id="staffpassword" placeholder="Staff Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_password']; ?>" required>  
      </div>
      </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("select * from tbl_staffs_a169167_pt2final LIMIT $start_from, $per_page");
        $stmt->execute();

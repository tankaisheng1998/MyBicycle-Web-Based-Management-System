...
<head>
  ...
  <title>MyBicycle : Customers</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          <label for="customerphone" class="col-sm-3 control-label">Customer Phone Number</label>
          <div class="col-sm-9">      
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("select * from tbl_customers_a169167_pt2final LIMIT $start_from, $per_page");
        $stmt->execute();
